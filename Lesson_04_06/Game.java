...
class Team {
    ...
    /**В качестве хранилища используем лист программистов */
...
/**Сущность, которая позволяет свести 2 команды между собой */
class Olympiad {
...
/**Сущность которая, случайным образом создает работников */
class Gb {
